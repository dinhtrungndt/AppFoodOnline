...
import com.example.appfoodv2.Activity.Bill.ContentBillAdMinActivity;
...
public class HoaDonAdMinAdapter extends RecyclerView.Adapter<HoaDonAdMinAdapter.ViewHodler> {
    ...
    @Override
    public HoaDonAdMinAdapter.ViewHodler onCreateViewHolder(ViewGroup parent, int viewType) {
        View view;
        if (type == 0 || type == 5) {
    ...
    @Override
    public void onBindViewHolder(HoaDonAdMinAdapter.ViewHodler holder, int position) {
